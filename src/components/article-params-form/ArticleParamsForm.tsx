...
export const ArticleParamsForm = ({
	...
	const [selectArticleState, setSelectArticleState] =
		useState<ArticleStateType>(article);
				...
				<form className={styles.form} onSubmit={handleSubmit} ref={rootRef}>
					...
					<Select
						...
						onChange={(selectElement: OptionType) =>
							setSelectArticleState((state) => ({
								...state,
								fontFamilyOption: selectElement,
							}))
						}
					/>
					<RadioGroup
